...
**Slice 3a — Compound foundation [DONE — this delivery]:** the trio that validates the compound pattern end-to-end on a trivial example, ported under `src/MetaGeneticSharp.Domain/Metaheuristics/Compound/` (flat namespace `MetaGeneticSharp`):
