...
{
    /// <summary>
    /// The default geometry embedding provides a pass-through between gene values
    /// and geometric (metric-space) values.
    ...
    {
        /// <summary>
        /// The default offspring creation is a pass-through between metric values and gene values.
        /// </summary>
        ...
        /// <summary>
        /// The default parent conversion uses the pass-through <see cref="IdentityMapToGeometry"/> method.
        /// </summary>
