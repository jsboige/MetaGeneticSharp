...
{
    /// <summary>
    ///   The Whale Optimisation Algorithm, a compound metaheuristic mimicking the bubble-net hunting
    ///   mechanism of humpback whales. As detailed in
    ///   <see href="https://en.wikiversity.org/wiki/Whale_Optimization_Algorithm">Whale Optimization Algorithm</see>
    ///   and implemented directly from
    ///   <see href="https://fr.mathworks.com/matlabcentral/fileexchange/55667-the-whale-optimization-algorithm?s_tid=srchtitle">The Whale Optimization Algorithm</see>.
    ///   This is the default and faster version of the algorithm with reduced lambda expressions.
    ...
    public class WhaleOptimisationAlgorithm : GeometricMetaHeuristicBase
    {
        ...
        // Declare the parameters used for better name access (note that the local variables won't be
        // used directly because they will be thread-safe / context-dependent parameters).
        ...
        /// <summary>An operator computing the encircling-prey gene value from a target and current individual.</summary>
        ...
        /// <summary>An operator computing the bubble-net (spiral) gene value from the best and current individual.</summary>
        ...
        /// <summary>The default helicoid scale applied in the bubble-net operator.</summary>
        public const double DefaultHelicoidScale = 1;

        /// <summary>
        /// Defines the default linear operator performing the encircling strategy, to be computed for each
        /// gene, converted to a double through the provided converter.
        /// </summary>
        ...
        /// <summary>Sets the amplitude of the cosine function applied in the bubble-net operator.</summary>
        public double HelicoidScale { get; set; } = DefaultHelicoidScale;

        /// <summary>The bubble-net operator defines the specific attack behavior with spiral updating.</summary>
        public BubbleNetOperator BubbleOperator { get; set; } = DefaultBubbleNetOperator;

        /// <summary>The encircling operator defines how an individual gets closer to a target individual.</summary>
        ...
        protected override IContainerMetaHeuristic BuildMainHeuristic()
        {
            ...
            // Defining the crossover operator to be applied with a random or best target, using the Encircling Prey Operator.
            ...
            var woaHeuristic = new IfElseMetaHeuristic()
                ...
                .WithParam(nameof(WoaParam.a2), "a2 linearly decreases from -1 to -2 to calculate t in Eq. (3.12)",
        ...
        /// <summary>Alternate version with distinct parameter definitions, kept for reference.</summary>
        ...
        /// <summary>A simple convex-combination bubble-net operator (default mix coefficient 0.5).</summary>
