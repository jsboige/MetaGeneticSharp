...
{
    /// <summary>
    ///   The Equilibrium Optimizer, a compound metaheuristic inspired by control-volume
    ///   mass balance to estimate both dynamic and equilibrium states. As detailed in
    ///   <see href="https://www.afshinfaramarzi.com/equilibrium-optimizer">Equilibrium Optimizer</see>
    ///   and implemented directly from
    ///   <see href="https://github.com/thieu1995/mealpy/blob/master/mealpy/physics_based/EO.py">the mealpy version</see>.
    ...
    public class EquilibriumOptimizer : GeometricMetaHeuristicBase
    {
        ...
        protected override IContainerMetaHeuristic BuildMainHeuristic()
        {
            ...
            // Defining the crossover operator to generate the centroid from the 4 best chromosomes.
            ...
            var eoHeuristic = new MatchMetaHeuristic()
                ...
                // Custom pick: random from the 4 best + the centroid.
